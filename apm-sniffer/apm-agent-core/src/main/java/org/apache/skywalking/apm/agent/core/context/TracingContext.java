...
public class TracingContext implements AbstractTracerContext {
    ...
    private static final AtomicIntegerFieldUpdater<TracingContext> ASYNC_SPAN_COUNTER_UPDATER = AtomicIntegerFieldUpdater
        .newUpdater(TracingContext.class, "asyncSpanCounter");
